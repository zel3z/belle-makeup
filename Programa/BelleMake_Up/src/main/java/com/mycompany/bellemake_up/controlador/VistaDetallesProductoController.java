...
public class VistaDetallesProductoController {
        ...
        try {
            ...
            for (String ruta : posiblesRutas) {
                ...
                if (defaultImageUrl != null) {
                    ...
                    System.out.println("️ Imagen por defecto cargada desde: " + ruta);
                    return;
                }
            }

            System.err.println(" No se pudo encontrar ninguna imagen por defecto");
    ...
    private void comprarAhora() {
        if (prod != null) {
            String mensaje = " Iniciando compra: " + prod.getNomprod() + " x" + cantidad;
            System.out.println(mensaje);
            mostrarAlerta("Compra", mensaje);
            // Aquí puedes abrir directamente la vista de checkout/pago
        }
    }
